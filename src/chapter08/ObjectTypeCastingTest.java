...
//		Circle cs2 = (Circle)s2; //강제(명시적) 형변환 X
		...
		ShapeInterface si2 = new Rectangle("초록", 10, 20);
		ShapeInterface si3 = new Triangle("은색", 10, 20);
//		(추상메소드)  ---다형성 구현 --- (상속받아 오버라이딩)
		
		Rectangle r12 = (Rectangle)si2;
		Triangle r13 = (Triangle) si3;

		r12.draw();
		System.out.println(r12.getArea());
		
		r13.draw();
		System.out.println(r13.getArea());
